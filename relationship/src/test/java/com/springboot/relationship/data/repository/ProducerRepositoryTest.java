...
public class ProducerRepositoryTest {
    ...
    void relationshipTest() {
        Product product1 = saveProduct("둥글펜", 500, 1000);
    ...
    void relationshipTest2() {
        ...
        product1.addProduct(producer1);
        product2.addProduct(producer1);
        product2.addProduct(producer2);
        product3.addProduct(producer2);
